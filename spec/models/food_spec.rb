...
RSpec.describe Food, type: :model do
  ...
  it 'expects food to be invalid when name exceeds the limit of 250 characters' do
    ...
    part3 = 'the food object becomes invalid. To do so, we have prepared a lengthy paragraph as an example.'
  ...
  it 'expects food to be invalid when measurement_unit exceeds the limit 250 characters' do
    part1 = 'We are testing the maximum length of the measurement_unit attribute in the Food model. measurement_'
    part2 = 'unit field has a limit of 250 characters, and we want to ensure that when the measurement_unit'
    part3 = 'exceeds this limit, the food object becomes invalid.To do so, we have prepared a lengthy paragraph'
    part4 = 'This test confirms that the application handles the case when measurement attribute exceeds the limit.'
